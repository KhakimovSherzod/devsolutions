export const metadata = {
  ...
  alternates: {
    canonical: 'https://vido.uz/terms-of-use',
  },
}
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='space-y-10 text-gray-300 leading-relaxed text-base md:text-lg'>
          ...
          <section>
            ...
            <p>
              Siz veb-saytdan faqat qonuniy maqsadlarda va ushbu Shartlarga muvofiq foydalanishingiz
              mumkin. Quyidagi harakatlar taqiqlanadi:
            </p>
            <ul className='list-disc list-inside mt-3 space-y-1'>
              <li>Sayt infratuzilmasiga zarar yetkazuvchi har qanday faoliyat;</li>
              <li>
                Ruxsatsiz maʼlumot yig‘ish yoki avtomatlashtirilgan dasturlar (bot, scraper) orqali
                foydalanish;
              </li>
          ...
          <section>
            ...
            <p>
              ...
              uchinchi tomon huquqlarini buzmaslik uchun masʼulsiz. Har qanday noqonuniy faoliyat
              aniqlansa, sizning hisobingiz yoki kirish huquqingiz cheklanishi mumkin.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Ushbu shartlar O‘zbekiston Respublikasining amaldagi qonunlariga muvofiq tartibga
              solinadi. Har qanday nizolar O‘zbekiston sudlarida ko‘rib chiqiladi.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Agar ushbu shartlar bo‘yicha savollaringiz bo‘lsa, biz bilan quyidagi manzillar orqali
